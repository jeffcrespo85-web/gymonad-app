...
export const mockTrainers: TrainerProfile[] = [
  {
    id: "trainer-1",
    name: "Sarah Johnson",
    bio: "Certified personal trainer specializing in strength training and HIIT workouts. 8+ years experience helping clients achieve their fitness goals.",
    specialties: ["Strength Training", "HIIT", "Weight Loss", "Muscle Building"],
    rating: 4.9,
    totalSessions: 1247,
  ...
  },
  {
    id: "trainer-3",
    name: "Emma Chen",
    bio: "Yoga instructor and wellness coach focused on mind-body connection and flexibility training.",
    ...
    streamUrl: "stream-3",
    hourlyRate: 60,
    certifications: ["RYT-500", "Meditation Teacher", "Corrective Exercise"],
    experience: 6,
...
export const mockLiveStreams: LiveStream[] = [
  {
    ...
    description: "High-intensity interval training session to kickstart your day. No equipment needed!",
    category: "HIIT",
    isLive: true,
    viewerCount: 47,
  ...
  },
  {
    ...
    description: "Start your day with mindful movement and breathing exercises.",
    category: "Yoga",
    isLive: true,
    viewerCount: 23,
    startTime: new Date(Date.now() - 8 * 60 * 1000), // Started 8 minutes ago
    duration: 45,
    thumbnailUrl: "/yoga-flow.png",
